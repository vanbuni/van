...
export default function UserProvider(props) {
  ...
  function logout() {
    ...
    setUserState({ user: {}, token: "", issues: [],  allIssues: [] })
  ...
  return (
    <UserContext.Provider value={{ ...userState, signUp, login, logout, addIssue, addUpVote, addDownVote, resetAuthErr, getIssues }}>
      {props.children}
