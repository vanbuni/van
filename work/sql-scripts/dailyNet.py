import requests
ids = ['POpYGoLVEbcEtwLyd7bacRdS', 'PTpYK6Xf6rfq5Sc1VooXu7uQ', 'PTpYM1qUkZYhNCFy6DpHQQJd', 'PTpYNbjXddNhj2695mmwNebj'
'CPpYQnfiJmJnh49PEYyqjbuE', 'CPpYRhXqUrSAqVvroLa5L1Ra', 'CPpYT1bUTGDpZAgosW4nRfjp'
]
Payout = '''
...
r = requests.patch('https://finix.sandbox-payments-api.com/settlement_engine/payout_plans/POpYGoLVEbcEtwLyd7bacRdS / patch', data ={'key':'value'})